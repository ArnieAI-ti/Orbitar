...
const styles = (theme) => ({
  section: {
    ...
    backgroundImage: `radial-gradient(rgba(255, 255, 255, 0.1) 0.5px, transparent 0.5px)`, // Textura de puntos sutil
    backgroundSize: "15px 15px",
    color: theme.palette.text.primary, // Asegura que el texto sea blanco
  },
  textContainer: {
  ...
  title: {
    ...
    textAlign: "center",
    fontWeight: "bold",
    color: theme.palette.text.primary, // Título principal en blanco
  },
  paragraph: {
    marginBottom: theme.spacing(2),
    textAlign: "justify",
    color: theme.palette.text.secondary, // Texto del cuerpo en gris claro
  },
  subheading: {
    textAlign: "left",
    color: theme.palette.text.primary, // Subtítulos en blanco
    fontWeight: "bold",
    marginTop: theme.spacing(4),
  },
  highlight: {
    color: theme.palette.primary.main, // Color de acento (cian)
    fontWeight: "bold",
  },
  imageContainer: {
    display: "flex",
  ...
  transversalCard: {
    backgroundColor: theme.palette.primary.dark, // Un color de fondo diferente para la tarjeta
    color: theme.palette.primary.contrastText, // Color de texto que contraste
          ...
          <Grid item xs={12} md={6} data-aos="fade-right">
            <Box className={classes.textContainer}>
              <Card className={classes.transversalCard}>
                <CardContent>
                  <Typography variant="h4" component="h3" sx={{ mb: 2, color: theme.palette.text.primary }}>
